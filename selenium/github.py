...
class Github:
    ...
    def signIn(self):
        ...
        username_field = self.browser.find_element_by_xpath("//input[@id='login_field']")
        password_field = self.browser.find_element_by_xpath("//input[@id='password']")
        ...
        login_button = self.browser.find_element_by_xpath("//input[@name='commit']")
        login_button.click()
